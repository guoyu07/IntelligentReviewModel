...
class reinforcement_assignment{
	 ...
	 * Setup MySQL	
 	 */	
	function __construct($semester,$diff,$ass_num, $min_concepts,$diff_threshold,$prefix){
		...
		$this->min_concepts = $min_concepts;
	...
	function main(){
		...
		$table_handle = new SQL_com($this->semester,$this->ass_num,$this->table_prefix);
		...
		foreach($users as $user){
			...
			$concepts = $user_stat_handle->GetDataDiffFilter($this->min_concepts,$this->diff_threshold);
