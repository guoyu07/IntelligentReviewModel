...
if($_SERVER["REQUEST_METHOD"]!="POST"){
	...
	input_form(0,$file);
	$handle = new reinforcement_assignment($_POST["semester"],$_POST["diff"],$_POST["ass_num"],$_POST["min"], $_POST["diff_thresh"], $_POST["prefix"]);
	$handle->main();
...
function input_form($form_status,$file){
	...
	print	'<tr><td>Semester ID:</td>
		<td><input	type="text"	name="semester"	value="Fall_2012"><br></td></tr>';
	print	'<tr><td>Table Prefix:</td>
		<td><input	type="text"	name="prefix"	value="reinf"><br></td></tr>';
	print	'<tr><td>Difficulty Alogrithm:</td>
  	...
  	print	'<tr><td>Assignment Number:</td>
		<td><input	type="text"	name="ass_num"	value=1><br></td></tr>';
	print	'<tr><td>Minimum Concepts:</td>
		<td><input	type="text"	name="min"	value=3><br></td></tr>'; 
	print	'<tr><td>Percent Difficulty Threshold:</td>
		 <td><input	type="text"	name="diff_thresh"	value=10><br></td></tr>'; 
