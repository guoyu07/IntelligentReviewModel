...
class ITS_screen
{
    ...
    function getContent()
    {
        ...
        switch ($this->screen) {
            ...
            case 5: // "NEW CONCEPTS BROWSER"
                ...
                break;
                //------------------//
      	    case 6: //REINFORCEMENT QUESTIONS
    ...
    function getTab($ch, $role, $view)
    {
        ...
        <li id="Intelligent Review Model" name="header" view="' . intval($view) . '" r="' . intval($role) . '" ch="' . $ch . '" style="margin-left: 50px;"><a href="#">Reinforcement	</a></li>
        </ul>';
